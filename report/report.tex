...
With this work as inspiration, we will consider cross-linguistic transfer over a more diverse set of word embeddings rather than only a BERT variant. While we do not conduct any qualitative analyses on our results, <>
...
In our first experiment, we found that the transformer embeddings BERT, XLNet, and T5 were of the highest quality. When tested on an even playing field (The same classifier, training procedures, etc.), they significantly outperformed Flair, and the static embeddings FastText. This indicates that their contextual embeddings encode a deeper understanding of the underlying syntactic and semantic patterns of the English language, and are thus better suited to POS tagging tasks.
