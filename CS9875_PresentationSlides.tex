...
\begin{frame}\centering
  ...
  We anticipate achieving near perfect scores in both evaluation metrics using embeddings from contextual models like BERT and a simple classification model like an SVM.
\end{frame}
\end{document}
