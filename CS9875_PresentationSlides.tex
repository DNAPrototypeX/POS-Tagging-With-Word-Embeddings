...
\begin{frame}\centering
  ...
  We anticipate achieving near perfect scores in both evaluation metrics using contextual embeddings from contextual models like BERT and a simple classification model like an SVM, outperforming static embedding models like Word2Vec.
\end{frame}
