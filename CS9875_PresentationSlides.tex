...
\begin{frame}
	...
	\begin{enumerate}
		...
		\end{itemize}
		\item Noun-Adjective: ``orange''
		\begin{itemize}
			\item ``I like to eat an \underline{orange} after working out.'' (N)
			\item ``The \underline{orange} car has arrived.'' (A)
		\end{itemize}
	\end{enumerate}
\end{frame}
\subsection*{Tagging}
...
\begin{frame}
	...
	\end{tabular}
	\end{center}
	What makes PoS tagging challenging: context is very important.
\end{frame}
...
\begin{frame}\centering
  ...
  \bigskip
  \tiny https://assets.zilliz.com/Figure\_Word\_Embeddings\_b021a5a759.png
  %TODO citation
\end{frame}
...
\bigskip
\tiny https://www.geeksforgeeks.org/nlp/word-embeddings-in-nlp/
\end{frame}
...
\begin{frame}\centering
 ...
 \bigskip
 \bigskip
 \tiny Transformer architecture: https://deeplobe.ai/wp-content/uploads/2021/04/1.jpg\\
 \tiny MLM: https://learnopencv.com/wp-content/uploads/2023/10/bert-masked-language-modeling-1.png
 \tiny Devlin, Jacob; Chang, Ming-Wei; Lee, Kenton; Toutanova, Kristina, 2018. BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding
 %TODO citation  
\end{frame}
...
%	\bigskip
%	\bigskip
%	\tiny {https://uploads-ssl.webflow.com/6266b596eef18c1931f938f9/64760748f6cfb67f889321ad\_classification\_metrics\_016-min.png}
%\end{frame}
...
\begin{frame}
	...
	\item Using an $\sim$10,000-word subset, splitting only on sentence boundaries
	\item We will train 6 embedding-classifier combinations on the same training set, and test each using the same testing set.
	\begin{itemize}
		\item Embeddings: Word2Vec (Static), BERT, ELMo
		\item Classifiers: SVM, AdaBoost
	\end{itemize}
	\item The performance of each combination will be evaluated using F1 score and AUC-ROC
	\end{itemize}
\end{frame}
...
\begin{frame}\centering
	...
	We will conduct a theoretical analysis on the word embedding models.
\end{frame}

\subsection*{Anticipated Results}
\begin{frame}\centering
	\frametitle{Anticipated Results}
	We anticipate achieving near perfect scores in both evaluation metrics using embeddings from contextual models like BERT and a simple classification model like an SVM, outperforming static embedding models like Word2Vec.
\end{frame}
